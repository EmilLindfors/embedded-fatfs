...
type FatApp = App<TokioFile, embedded_fatfs::ChronoTimeProvider, embedded_fatfs::LossyOemCpConverter>;
...
fn ui(f: &mut Frame, app: &mut FatApp) {
    ...
    .block(Block::default().borders(Borders::ALL).title("embedded-fatfs"));
